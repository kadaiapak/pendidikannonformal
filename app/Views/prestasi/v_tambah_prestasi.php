...
<div class="right_col" role="main">
    <div class="">
        ...
        <form class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data" action="<?= base_url('admin/prestasi/simpan'); ?>">
            <?= csrf_field(); ?>
        <div class="row">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="prestasi_judul" value="<?= old('prestasi_judul'); ?>" name="prestasi_judul" class="form-control <?= validation_show_error('prestasi_judul') ? 'is-invalid' : null; ?>" name="prestasi_judul" placeholder="Tuliskan judul"/>
                            <div class="invalid-feedback" style="text-align: left;">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="prestasi_deskripsi" id="prestasi_deskripsi" class="form-control <?= validation_show_error('prestasi_deskripsi') ? 'is-invalid' : null; ?>" cols="10" rows="10"><?= old('prestasi_deskripsi'); ?></textarea>
                            <div class="invalid-feedback" style="text-align: left;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="prestasi_penyelenggara" value="<?= old('prestasi_penyelenggara'); ?>" name="prestasi_penyelenggara" class="form-control <?= validation_show_error('prestasi_penyelenggara') ? 'is-invalid' : null; ?>" name="prestasi_penyelenggara" placeholder="Tuliskan siapa penyelenggara lomba tersebut"/>
                            <div class="invalid-feedback" style="text-align: left;">
                        ...
                        <div class="form-group">
                            ...
                            <select name="prestasi_tahun" id="prestasi_tahun" class="form-control <?= validation_show_error('prestasi_tahun') ? 'is-invalid' : null; ?>" required>
                                ...
                                <?php for ($i= $tahun-5; $i <= $tahun; $i++) { ?>
                                    <option value="<?= $i; ?>" <?= old('prestasi_tahun') == $i ? "selected" : null ; ?>><?= $i; ?></option>
                                <?php } ?>
                            </select>
                            <div class="invalid-feedback" style="text-align: left;">
                        ...
                        <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input required <?= validation_show_error('prestasi_tanggal_mulai') ? "style='border : 1px solid red'" : null?> placeholder="tanggal mulai observasi" type="text" value="<?= old('prestasi_tanggal_mulai'); ?>" class="form-control datepicker" name="prestasi_tanggal_mulai">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input required <?= validation_show_error('prestasi_tanggal_selesai') ? "style='border : 1px solid red'" : null?> placeholder="sampai tanggal berapa" type="text" value="<?= old('prestasi_tanggal_selesai'); ?>" class="form-control datepicker" name="prestasi_tanggal_selesai">
                                    <div class="invalid-feedback" style="text-align: left; display: block;">
                        ...
                        <div class="form-group">
                            ...
                            <select name="prestasi_tingkat" id="prestasi_tingkat" class="form-control <?= validation_show_error('prestasi_tingkat') ? 'is-invalid' : null; ?>" required>
                                ...
                                <option value="1" <?= old('prestasi_tingkat') == "1" ? "selected" : null ; ?>>Kabupaten / Kota</option>
                                <option value="2" <?= old('prestasi_tingkat') == "2" ? "selected" : null ; ?>>Provinsi</option>
                                <option value="3" <?= old('prestasi_tingkat') == "3" ? "selected" : null ; ?>>Nasional</option>
                                <option value="4" <?= old('prestasi_tingkat') == "4" ? "selected" : null ; ?>>Internasional</option>
                            </select>
                            <div class="invalid-feedback" style="text-align: left;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="prestasi_peringkat" value="<?= old('prestasi_peringkat'); ?>" name="prestasi_peringkat" class="form-control <?= validation_show_error('prestasi_peringkat') ? 'is-invalid' : null; ?>" name="prestasi_peringkat" placeholder="Tuliskan juara berapa pada lomba tersebut"/>
                            <div class="invalid-feedback" style="text-align: left;">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="prestasi_nim" value="<?= old('prestasi_nim'); ?>" name="prestasi_nim" class="form-control <?= validation_show_error('prestasi_nim') ? 'is-invalid' : null; ?>" name="prestasi_nim" placeholder="Tuliskan NIM pemenang"/>
                            <div class="invalid-feedback" style="text-align: left;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="prestasi_nama" value="<?= old('prestasi_nama'); ?>" name="prestasi_nama" class="form-control <?= validation_show_error('prestasi_nama') ? 'is-invalid' : null; ?>" name="prestasi_nama" placeholder="Tuliskan NIM pemenang"/>
                            <div class="invalid-feedback" style="text-align: left;">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <img id="sertifikat_load" src="<?= base_url('/image_manager/pattern.jpg'); ?>" alt="" style="width: 400px;" class="img-thumbnail img-preview">
                            </div>
                        </div>
                    </div>
                </div>
