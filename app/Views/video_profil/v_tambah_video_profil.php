...
<div class="right_col" role="main">
    <div class="">
        ...
        <form class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data" action="<?= base_url('admin/video-profil/simpan'); ?>">
            <?= csrf_field(); ?>
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Tambah Video Profil</h2>
                        <div class="clearfix"></div>
                    ...
                    <div class="x_content">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="vp_judul" value="<?= old('vp_judul'); ?>" name="vp_judul" class="form-control <?= validation_show_error('vp_judul') ? 'is-invalid' : null; ?>" name="vp_judul" placeholder="Tuliskan judul"/>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="vp_deskripsi" id="vp_deskripsi" class="form-control <?= validation_show_error('vp_deskripsi') ? 'is-invalid' : null; ?>" cols="10" rows="10"><?= old('vp_deskripsi'); ?></textarea>
                            <div class="invalid-feedback" style="text-align: left;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="vp_youtube_link" value="<?= old('vp_youtube_link'); ?>" name="vp_youtube_link" class="form-control <?= validation_show_error('vp_youtube_link') ? 'is-invalid' : null; ?>" name="vp_youtube_link" placeholder="Isikan link video youtube"/>
                            <div class="invalid-feedback" style="text-align: left;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="vp_youtube_title" value="<?= old('vp_youtube_title'); ?>" name="vp_youtube_title" class="form-control <?= validation_show_error('vp_youtube_title') ? 'is-invalid' : null; ?>" name="vp_youtube_title" placeholder="Tuliskan judul video youtube"/>
                            <div class="invalid-feedback" style="text-align: left;">
