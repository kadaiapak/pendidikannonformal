        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('admin/kategori/simpan'); ?>">
                            <?= csrf_field(); ?>
                            <div class="form-group row ">
                                <label class="control-label col-md-3 col-sm-3" for="kategori_nama">Nama Kategori</label>
                                <div class="col-md-9 col-sm-9 ">
                                    <input type="text" name="kategori_nama"  class="form-control <?= validation_show_error('kategori_nama') ? 'is-invalid' : null; ?>" id="kategori_nama">
