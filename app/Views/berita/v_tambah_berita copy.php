                    ...
                    <div class="x_content">
                        ...
                        <div class="form-group">
                            ...
                            <select name="berita_kategori" id="berita_kategori" class="form-control <?= validation_show_error('berita_kategori') ? 'is-invalid' : null; ?>" required>
                                ...
                                <?php foreach ($semua_kategori as $sk) { ?>
                                    <option value="<?= $sk['kategori_id']; ?>" <?= old('berita_kategori') == $sk['kategori_id'] ? "selected" : null ; ?>><?= $sk['kategori_nama']; ?></option>
                                <?php } ?>
                            </select>
                            <div class="invalid-feedback" style="text-align: left;">
                        ...
                        <div class="form-group">
                            ...
                            <select id="berita_is_penting" name="berita_is_penting" class="form-control" required>
                                ...
                                <option value="1">Ya, Tampilkan di menu berita utama</option>
