...
<div class="right_col" role="main">
    <div class="">
        ...
        <form class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data" action="<?= base_url('/admin/halaman/simpan'); ?>">
            <?= csrf_field(); ?>
        <div class="row">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="halaman_nama" value="<?= old('halaman_nama'); ?>" name="halaman_nama" class="form-control <?= validation_show_error('halaman_nama') ? 'is-invalid' : null; ?>" name="halaman_nama" placeholder="Tuliskan Nama Halaman"/>
                            <div class="invalid-feedback" style="text-align: left;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="halaman_judul_isi" value="<?= old('halaman_judul_isi'); ?>" name="halaman_judul_isi" class="form-control <?= validation_show_error('halaman_judul_isi') ? 'is-invalid' : null; ?>" name="halaman_judul_isi" placeholder="Tuliskan judul dari isi halaman"/>
                            <div class="invalid-feedback" style="text-align: left;">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="halaman_isi" id="halaman_isi" class="form-control <?= validation_show_error('halaman_isi') ? 'is-invalid' : null; ?>" cols="10" rows="10"><?= old('halaman_isi'); ?></textarea>
                            <div class="invalid-feedback" style="text-align: left;">
                        ...
                        <div class="form-group">
                            ...
                            <select name="menu_id" id="menu_id" class="form-control <?= validation_show_error('menu_id') ? 'is-invalid' : null; ?>">
                                ...
                                <?php foreach ($semuaMenu as $sm) { ?>
                                    <option value="<?= $sm['kode_menu']; ?>" <?= old('menu_id') == $sm['kode_menu'] ? "selected" : null ; ?>><?= $sm['nama_menu']; ?></option>
                                <?php } ?>
                            </select>
                            <div class="invalid-feedback" style="text-align: left;">
