            ...
            <div class="col-md-9 col-sm-9">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <?php endif; ?>
                        <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('/admin/menu/simpan-submenu'); ?>">
                            <?= csrf_field(); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <select name="main_menu" id="main_menu" class="form-control <?= validation_show_error('main_menu') ? 'is-invalid' : null; ?>">
                                        ...
                                        <option value="<?= $mm['kode_menu']; ?>" <?= old("main_menu") == $mm['kode_menu'] ? "selected" : null ; ?>><?= $mm['nama_menu']; ?></option>
                                        <?php } ?>
                                    </select>
                                    <div class="invalid-feedback" style="text-align: left;">
