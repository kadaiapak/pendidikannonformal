                    ...
                    <div class="blog-content col-md-10 col-md-offset-1">
                        <div class="item-box">
                            <div class="item">
                                <div class="info">
                                    <h3>
                                        Panduan Penggunaan Aplikasi Sistem Informasi Beasiswa
                                    </h3>
                                    <div class="meta">
                                    </div>
                                    <p>
                                        Berikut kami jabarkan tata cara penggunaan aplikasi sistem informasi beasiswa
                                    </p>
                                    
                                    <p style="margin-top: 20px;">
                                        Demikian dijabarkan panduan atau tata cara penggunaan sistem informasi beasiswa, semoga bisa menjadi pedoman dalam pelaksanaan nantinya.
                                    </p>
                                    <blockquote>
