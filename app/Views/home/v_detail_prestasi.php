            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="<?= base_url('/semua-prestasi'); ?>">Prestasi</a></li>
                    ...
                    <div class="blog-content col-md-8">
                        <div class="item-box">
                            <div class="item">
                                <div class="thumb">
                                    <a href="#">
                                        <div class="image_contaner" style="width: 100%; height: 400px;">
                                            <img style="object-fit: cover; height: 100%; width: 100%;" src="<?= base_url('/upload/prestasi/'.$detailPrestasi['prestasi_sampul']); ?>" alt="Thumb">
                                        </div>  
                                    </a>
                                    <?php $tanggal_prestasi = tanggal_indo($detailPrestasi['created_at']);
                                          $array_tanggal_prestasi = explode(' ', $tanggal_prestasi); 
                                            ?>
                                    <div class="date">
                                ...
                                <div class="info">
                                    <h3>    
                                        <?= $detailPrestasi['prestasi_judul']; ?>
                                    </h3>
                                    <div class="meta">
                                        <ul>
                                            <li><a href="#"><i class="fas fa-user"></i> <?= $detailPrestasi['nama_user']; ?></a></li>
                                        </ul>
                                        <div class="share">
