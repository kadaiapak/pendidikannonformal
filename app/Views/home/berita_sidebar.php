    ...
    <aside>
        ...
        <div class="sidebar-item recent-post">
            ...
            <?php foreach ($semuaBerita as $sb) { ?>
                ...
                <div class="content">
                    <div class="thumb"  >
                        <a href="<?= base_url('/berita/'.$sb['berita_slug']); ?>">
                            <img src="<?= base_url('upload/berita_sampul/'.$sb['berita_sampul']); ?>" alt="Thumb">
                        </a>
                    </div>
                    <div class="info">
                        <h4>
                        ...
                        <div class="meta">
                            <i class="fas fa-eye"></i><a href="<?= base_url('/berita/'.$sb['berita_slug']); ?>"><?= $sb['berita_tayang']; ?> dilihat</a> 
                        </div>
                    </div>
                </div>
            </div>
