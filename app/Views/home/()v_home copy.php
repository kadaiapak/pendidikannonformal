        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                    ...
                    <video autoplay muted loop src="<?= base_url('upload/video/video.mp4'); ?>">
                    </video>
                    <p>
            ...
            <div class="row">
                <div class="col-md-6 content">
                    ...
                    <!-- item -->
                            <div class="item">
                                <div class="icon">
                                    <h1 style="border-bottom: 1px solid #ffb606;">29</h1>
                                    <h1>02</h1>
                                </div>
                                <div class="info">
                                    <h4>
                                    ...
                                    <p>
                                        Sistem Informasi Kerja dan Tata Kelola Kemahasiswaan.
                                    </p>
                                </div>
                            </div>
                    <!-- item -->
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            ...
                            <div class="item">
                                <div class="icon">
                                    <h1 style="border-bottom: 1px solid #ffb606;">12</h1>
                                    <h1>05</h1>
                                </div>
                                <div class="info">
                                    <h4>
                                    ...
                                    <p>
                                        Peksiminas merupakan pekan seni mahasiswa nasional, yang dilangsungkan di setiap kampus di indonesia
                                    </p>
                                </div>
                            </div>
                    <!-- item -->  
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            ...
                            <div class="item">
                                <div class="icon">
                                    <h1 style="border-bottom: 1px solid #ffb606;">04</h1>
                                    <h1>01</h1>
                                </div>
                                <div class="info">
                                    <h4>
                ...
                <div class="col-lg-8 col-md-8 col-sm-12">
                    <div class="blog-items">
                        ...
                        <div class="single-item">
                            <div class="item">
                                <div class="thumb">
                                    <a href="#"><img src="<?= base_url()?>template_front_end/assets/img/berita_satu.jpg" alt="Thumb"></a>
                                    <div class="date">
                                        <h4><span>24</span> Nov, 2018</h4>
                                    </div>
                                </div>
                                <div class="info">
                                    <h3>
                                        <a href="#">UNP Lantik Pengurus UKM Baru: Arah Baru untuk Masa Depan Mahasiswa dan Inovasi Digital</a>
                                    </h3>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="blog-items">
                    ...
                    <div class="sidebar col-md-4">
                        <aside>
                            ...
                            <div class="sidebar-item recent-post">
                                <div class="title">
                                    <h4>Organisasi dan Kesejahteraan Mahasiswa</h4>
                                </div>
                                ...
                                <div class="item">
                                    <div class="content">
                                        <div class="thumb">
                                            <a href="#">
                                                <img src="<?= base_url()?>template_front_end/assets/img/berita_satu.jpg" alt="Thumb">
                                            </a>
                                        </div>
                                        <div class="info">
                                            <h4>
                                                <a href="#">UNP Lantik Pengurus UKM Baru</a>
                                            </h4>
                                            <div class="meta">
                                ...
                                <div class="item">
                                    <div class="content">
                                        ...
                                        <div class="info">
                                            ...
                                            <div class="meta">
                                                <i class="fas fa-user"></i> By <a href="#">Admin UNP</a> 
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="sidebar-item recent-post">
                                ...
                                <div class="item">
                                    <div class="content">
                                        <div class="thumb">
                                            <a href="#">
                                                <img src="<?= base_url()?>template_front_end/assets/img/prestasi_satu.jpg" alt="Thumb">
                                            </a>
                                        </div>
                                        <div class="info">
                                            <h4>
                                                <a href="#">Juara Terbaik V dalam ajang Pemilihan Duta Bahasa Tingkat Nasional Tahun 2023</a>
                                            </h4>
                                            <div class="meta">
                                                <i class="fas fa-user"></i> By <a href="#">Drup Paul</a> 
                                            </div>
                                ...
                                <div class="item">
                                    <div class="content">
                                        <div class="thumb">
                                            <a href="#">
                                                <img src="<?= base_url()?>template_front_end/assets/img/prestasi_dua.jpg" alt="Thumb">
                                            </a>
                                        </div>
                                        <div class="info">
                                            <h4>
                                                <a href="#">Juara I Duta Genre Putri Kota Padang dan Runner Up III Duta Genre Putri Sumatera Barat Tahun 2023</a>
                                            </h4>
                                            <div class="meta">
                                                <i class="fas fa-user"></i> By <a href="#">Drup Paul</a> 
                                            </div>
                                ...
                                <div class="item">
                                    <div class="content">
                                        <div class="thumb">
                                            <a href="#">
                                                <img src="<?= base_url()?>template_front_end/assets/img/prestasi_tiga.jpg" alt="Thumb">
                                            </a>
                                        </div>
                                        <div class="info">
                                            <h4>
                                                <a href="#"> Juara I Kompetisi Nasional Seni Budaya yang diselenggarakan oleh Universitas Pancasila 2023</a>
                                            </h4>
                                            <div class="meta">
                                                <i class="fas fa-user"></i> By <a href="#">Drup Paul</a> 
                                            </div>
                    ...
                    <!-- End Start Sidebar -->
                    <div class="more-btn col-md-12 text-center">
                        <a href="#" class="btn btn-dark border btn-md">LIHAT SEMUA INFORMASI</a>
                    </div>
                </div>
            </div>
        </div>
