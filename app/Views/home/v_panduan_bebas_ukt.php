                    ...
                    <div class="blog-content col-md-10 col-md-offset-1">
                        <div class="item-box">
                            <div class="item">
                                <div class="info">
                                    <h3>
                                        Panduang Pengajuan Pembebasan UKT Berprestasi
                                    </h3>
                                    <div class="meta">
                                    </div>
                                    <p>
                                        Berikut jelaskan beberapa panduan pengajuan bebas UKT karna berprestasi
                                    </p>
                                    
                                    <p style="margin-top: 20px;">
                                        Demikian dijabarkan panduan mahasiswa tahun 2024, semoga bisa menjadi pedoman dalam pelaksanaan nantinya.
                                    </p>
                                    <blockquote>
